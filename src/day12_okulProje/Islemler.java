...
public class Islemler {
    ...
    private static void silme() { // silme islemi de tc ile yapilacak
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")) {
            ...
            if (flag) { // eger girilen tc listede yoksa bu if calisir
            ...
            for (Kisi each : ogrtmnList) {
                if (each.getKimlikNo().equals(silinecekKimlikNo)) {
                    ...
                    ogrtmnList.remove(each);// o ogretmeni siler
                    flag = false;
                    break;
                }
            }
            if (flag) {// kullanicinin girdigi tc kimlik no hic bir ogretmenle eslesmedi
    ...
    private static void listeleme() {
        ...
        // burada iki farkli yontemle yaptik
    ...
    private static void arama() {
        ...
        boolean flag = true;//bayrak yukarda true olan her sart devam eder aksiyon baslasin
    ...
    private static void ekle() {//bu method hem ogrenci hem de ogretmen eklemek icin tasarlandi
        ...
        if (kisiTuru.equals("OGRENCI")) {
            ...
            Ogrenci ogrenci = new Ogrenci(adSoyad, kimliNo, yas, ogrenciNo, sinif); // yeni bir obje olusturduk
